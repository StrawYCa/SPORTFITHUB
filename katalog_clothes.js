const products = [
    { id: 1, name: 'BCAA Electrolyte', img: 'assets/diva.png' },
    { id: 2, name: 'BCAA Electrolyte', img: 'assets/diva.png' },
    { id: 3, name: 'BCAA Electrolyte', img: 'assets/card.png' },
    { id: 4, name: 'BCAA Electrolyte', img: 'assets/card.png' },
    { id: 5, name: 'BCAA Electrolyte', img: 'assets/card.png' },
];
    ...
    for (let i = 0; i < 42; i++) {
        ...
        <!-- Кнопка с данными -->
                <button class="add-btn" 
                    ...
                    data-price="760" 
                    data-image="image.png">Добавить в <img src='assets/bin.png' class='bin'><i class="fa-solid fa-cart-shopping"></i></button>
            </div>
            </div>
